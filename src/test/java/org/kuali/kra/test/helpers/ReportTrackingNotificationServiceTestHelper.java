...
public class ReportTrackingNotificationServiceTestHelper extends TestHelper {
	private static class ReportTrackingTestHelper extends TestHelper {
		private static class ReportTrackingDefault {
			private static final String PI_PERSON_ID = PersonFixture.QUICKSTART.getPrincipalId();
			...
			private static final String LAST_UPDATE_USER = PersonFixture.QUICKSTART.getPrincipalName();
			...
			private static final String UPDATE_USER = PersonFixture.QUICKSTART.getPrincipalName();
