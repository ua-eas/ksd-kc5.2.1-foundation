...
public class ProtocolDocumentRuleTest extends ProtocolRuleTestBase {
	 ...
	 * Specifically it tests 3 different cases: 1. Protocol has no research areas -- should give no error as rule is
	 * satisfied trivially. 2. Protocol has research areas and all are active -- should give no error 3. Protocol has
	 * research areas and some are inactive -- should give a single error with the error-property correctly encoding the
